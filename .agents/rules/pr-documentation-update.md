...
> "update @docs/overview/001-product-vision.md @docs/overview/002-prd.md @docs/overview/003-srs.md the ADRs and the BDD feature scenarios based on the changes introduced in this branch."
...
2. **Update Core Documents:** The agent MUST verify and update (`docs/overview/001-product-vision.md`, `docs/overview/002-prd.md`, `docs/overview/003-srs.md`) to reflect the new state of the application.
