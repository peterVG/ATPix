...
**Version:** 1.5  
**Last Updated:** 2026-07-12T20:00:00Z  
**Status:** Draft — stakeholder review  
**Sources:** [Product Vision](./product-vision.md) · [AGENTS.md](../AGENTS.md) · [AT Protocol KB](../.agents/kb/at-protocol.md) · [HappyView KB](../.agents/kb/happyview.md) · [C2PA KB](../.agents/kb/c2pa.md)
...
**Source:** [product-vision.md](./product-vision.md) — Core Features, User Requirements  
...
**Source:** [product-vision.md](./product-vision.md) — Core Features, User Requirements, Key Constraints  
...
**Source:** [product-vision.md](./product-vision.md) — Core Features; [Gallery Population Model](#gallery-population-model) Path A
...
**Source:** [product-vision.md](./product-vision.md) — Core Features, User Requirements, Key Constraints, Unfair Advantage  
...
**Source:** [product-vision.md](./product-vision.md) — Core Features; [Gallery Population Model](#gallery-population-model) Path B  
...
**Rationale:** [product-vision.md](./product-vision.md) — Standards, Laws, and Regulations; Key Constraints.
...
**Rationale:** [AGENTS.md](../AGENTS.md) — Minimize Dependencies; [product-vision.md](./product-vision.md) — Technical Stack.
...
| **Index database** | SQLite (dev); Postgres MAY be used in production | Per [product-vision.md](./product-vision.md) |
...
**Rationale:** [product-vision.md](./product-vision.md) — Technical Stack; [happyview.md](../.agents/kb/happyview.md).
...
**Rationale:** [product-vision.md](./product-vision.md) — Key Constraints.
...
**Rationale:** [product-vision.md](./product-vision.md) — Key Constraints; F-008; ATP-0016 space storage model.
...
- Expands [product-vision.md](./product-vision.md) features into user stories with acceptance criteria
