...
**UI requirements:** Screen layouts, component states, and design-token application are specified in [004-ui-requirements.md](./004-ui-requirements.md) (derived from [000-UX-guide.md](../references/000-UX-guide.md) and v1 mockups). This SRS retains verifiable behavioral requirements; UI-SCR-* IDs in the UI spec link back to SRS-F-* blocks here.
...
**Source**
- [002-prd.md](./002-prd.md) F-001: atproto OAuth Sign-In

**Tests**
- [`oauth_sign_in_SRS-F-001.feature`](../../apps/frontend/tests/features/oauth_sign_in_SRS-F-001.feature)
- [`oauthClientMetadata.test.js`](../../apps/frontend/tests/unit/oauthClientMetadata.test.js)
- [`app.test.js`](../../apps/frontend/tests/unit/app.test.js)
- [`signIn.ui.test.js`](../../apps/frontend/tests/ui/signIn.ui.test.js)
...
**Source**
- [002-prd.md](./002-prd.md) F-001, TC-006
...
**Source**
- [002-prd.md](./002-prd.md) F-001

**Tests**
- [`oauth_sign_in_SRS-F-001.feature`](../../apps/frontend/tests/features/oauth_sign_in_SRS-F-001.feature)

### SRS-F-001.4: Hosted PDS signup discovery link

When `VITE_PDS_SIGNUP_URL` is set, the unauthenticated sign-in panel MUST render a link to the configured PDS registration URL with copy directing users to create a `*.pds.atpix.net` handle and return to sign in. When unset, the link MUST NOT appear.

**Technical Implementation:**
- `apps/frontend/src/config/pdsSignup.js` resolves `VITE_PDS_SIGNUP_URL`.
- `apps/frontend/src/components/SignInPanel.js` renders `data-testid="pds-signup-link"` when configured.

**Architecture**
- [006-oauth-dpop-authentication.md](../architecture/006-oauth-dpop-authentication.md) — account creation boundary; signup discovery config

**Source**
- [002-prd.md](./002-prd.md) F-017: Hosted PDS Account Onboarding

**Tests**
- [`signInPanel.test.js`](../../apps/frontend/tests/unit/signInPanel.test.js)
- [`signIn.ui.test.js`](../../apps/frontend/tests/ui/signIn.ui.test.js)
- [`pdsSignup.test.js`](../../apps/frontend/tests/unit/pdsSignup.test.js)

---

## SRS-F-017: Hosted PDS Account Onboarding

Maps to PRD F-017. v1.1 delivers signup discovery via SRS-F-001.4.

**Source**
- [002-prd.md](./002-prd.md) F-017

**Tests**
- SRS-F-001.4 test artifacts above

---

## SRS-F-018: Embedded Signup on atpix.net (post-v1)

The application SHOULD provide embedded PDS registration on atpix.net per PRD F-018. Not implemented in v1.

**Source**
- [002-prd.md](./002-prd.md) F-018

**Tests**
- Planned: `ui_embedded_signup_UI-SCR-009.feature` (Task 9.1)

---

## SRS-F-019: ATPix-Managed PDS Invites (post-v1)

Operator invite issuance and revocation for hosted PDS registration per PRD F-019. Not implemented in v1.

**Source**
- [002-prd.md](./002-prd.md) F-019

**Tests**
- Planned: operator admin integration tests (Task 9.2)

---

## SRS-F-020: Apex Handle Provisioning at Scale (post-v1)

Automated `_atproto` TXT publication for apex handles such as `jane.atpix.net` per PRD F-020. Default onboarding remains `*.pds.atpix.net`.

**Source**
- [002-prd.md](./002-prd.md) F-020

**Tests**
- Planned: DNS automation integration tests (Task 9.3)

---

## SRS-F-021: Entryway and Multi-PDS Federation (post-v1)

Multi-PDS and Entryway deployment modes with correct OAuth issuer resolution per PRD F-021.

**Source**
- [002-prd.md](./002-prd.md) F-021

**Tests**
- Planned: multi-PDS OAuth integration tests (Task 9.4)
...
**Source**
- [002-prd.md](./002-prd.md) F-002, NFR-005
...
**Source**
- [002-prd.md](./002-prd.md) F-002, TC-002
...
**Source**
- [002-prd.md](./002-prd.md) F-004, F-015
...
**Source**
- [002-prd.md](./002-prd.md) F-004, F-010
...
**Source**
- [002-prd.md](./002-prd.md) F-005, F-010
...
**Source**
- [002-prd.md](./002-prd.md) F-008, TC-004, TC-008, NFR-013
...
**Source**
- [002-prd.md](./002-prd.md) F-008, NFR-002
...
**Source**
- [002-prd.md](./002-prd.md) F-008, TC-004
...
**Source**
- [002-prd.md](./002-prd.md) F-010, TC-012
...
**Source**
- [002-prd.md](./002-prd.md) F-011, TC-012
...
**Source**
- [002-prd.md](./002-prd.md) F-012, NFR-014, TC-009, TC-010
...
**Source**
- [002-prd.md](./002-prd.md) F-012, NFR-015
...
**Source**
- [002-prd.md](./002-prd.md) F-013, TC-010
...
**Source**
- [002-prd.md](./002-prd.md) F-014, NFR-016
...
**Source**
- [002-prd.md](./002-prd.md) F-014, NFR-016, TC-011
...
**Source**
- [002-prd.md](./002-prd.md) NFR-011

**Tests**
- [`gallery_query_performance_SRS-NFR-011.feature`](../../apps/backend/tests/features/gallery_query_performance_SRS-NFR-011.feature)
- Locust load script (`apps/backend/tests/performance/locust_gallery.py`) — planned in [005-plan.md](./005-plan.md) Task 7.2
...
**Source**
- [002-prd.md](./002-prd.md) NFR-017

**Tests**
- [`c2pa_validation_performance_SRS-NFR-017.feature`](../../apps/backend/tests/features/c2pa_validation_performance_SRS-NFR-017.feature)
- Locust load script (`apps/backend/tests/performance/locust_c2pa.py`) — planned in [005-plan.md](./005-plan.md) Task 7.2
...
**Source**
- [002-prd.md](./002-prd.md) Technical Constraints TC-001 through TC-012
...
| F-017 | SRS-F-017, SRS-F-001.4 | ✅ Mapped (v1.1 link) |
| F-018 | SRS-F-018 | 📋 Post-v1 planned |
| F-019 | SRS-F-019 | 📋 Post-v1 planned |
| F-020 | SRS-F-020 | 📋 Post-v1 planned |
| F-021 | SRS-F-021 | 📋 Post-v1 planned |
...
**Coverage:** 49/49 PRD requirement identifiers mapped (100%; F-018–F-021 post-v1 placeholders).