...
**Source:** [product-vision.md](./001-product-vision.md) — Core Features, User Requirements  
...
**Source:** [product-vision.md](./001-product-vision.md) — Core Features, User Requirements, Key Constraints  
...
**Source:** [product-vision.md](./001-product-vision.md) — Core Features; [Gallery Population Model](#gallery-population-model) Path A
...
**Source:** [product-vision.md](./001-product-vision.md) — Core Features; [Gallery Population Model](#gallery-population-model)
...
**Source:** [product-vision.md](./001-product-vision.md) — Core Features
...
**Source:** [product-vision.md](./001-product-vision.md) — Core Features, User Requirements, Key Constraints, Unfair Advantage  
...
**Source:** [product-vision.md](./001-product-vision.md) — Core Features; [Gallery Population Model](#gallery-population-model) Path B  
...
**Source:** [product-vision.md](./001-product-vision.md) — Unfair Advantage, Key Constraints, Technical Stack  
...
**Rationale:** Core value proposition—portable, user-owned libraries ([product-vision.md](./001-product-vision.md)); HappyView spaces model (blob on PDS, gated record access in space).
...
**Rationale:** [product-vision.md](./001-product-vision.md) — Standards, Laws, and Regulations; Key Constraints.
...
**Rationale:** [AGENTS.md](../../AGENTS.md) — Minimize Dependencies; [product-vision.md](./001-product-vision.md) — Technical Stack.
...
| **Index database** | SQLite (dev); Postgres MAY be used in production | Per [product-vision.md](./001-product-vision.md) |
...
**Rationale:** [product-vision.md](./001-product-vision.md) — Technical Stack; [happyview.md](../../.agents/kb/happyview.md).
...
**Rationale:** [product-vision.md](./001-product-vision.md) — Key Constraints.
...
**Rationale:** [product-vision.md](./001-product-vision.md) — Key Constraints; F-008; ATP-0016 space storage model.
...
- Expands [product-vision.md](./001-product-vision.md) features into user stories with acceptance criteria
