...
Granular checklist for the Vite vanilla JS client. Global sequencing: [docs/overview/005-plan.md](../../../docs/overview/005-plan.md).
...
**SRS source:** [docs/overview/003-srs.md](../../../docs/overview/003-srs.md) (no module-local srs.md)

**UI source:** [docs/overview/004-ui-requirements.md](../../../docs/overview/004-ui-requirements.md) · [000-UX-guide.md](../../../docs/references/000-UX-guide.md)
...
- [ ] **Task FE-1.1: Frontend build, lint, and test harness**
  ...
  - **Dependencies:** None
  - **Related Requirements:** [NFR-006](../../../docs/overview/002-prd.md#nfr-006-testability-and-quality-gates), [SRS-NFR-006](../../../docs/overview/003-srs.md#srs-nfr-006-testability-and-quality-gates)
...
- [ ] **Task FE-1.2: HappyView client module and environment wiring**
  ...
  - **Related Requirements:** [TC-001](../../../docs/overview/002-prd.md#tc-001-happyview-app-view), [TC-006](../../../docs/overview/002-prd.md#tc-006-api-client-identification), [SRS-F-001.2](../../../docs/overview/003-srs.md#srs-f-001-atproto-oauth-sign-in)
...
- [x] **Task FE-1.3: OAuth client metadata endpoint**
  ...
  - **Related Requirements:** [F-008](../../../docs/overview/002-prd.md#f-008-permissioned-gallery--album-access-happyview-permissioned-spaces-validation), [SRS-F-008.1](../../../docs/overview/003-srs.md#srs-f-008-permissioned-album-access-happyview-spaces)
...
- [x] **Task FE-2.1: OAuth sign-in, shell chrome, and theme toggle (holistic)**
  ...
  - **Related Requirements:** [F-001](../../../docs/overview/002-prd.md#f-001-atproto-oauth-sign-in), [SRS-F-001](../../../docs/overview/003-srs.md#srs-f-001-atproto-oauth-sign-in), [UI-SHELL-001](../../../docs/overview/004-ui-requirements.md#ui-shell-001-application-chrome), [UI-SHELL-002](../../../docs/overview/004-ui-requirements.md#ui-shell-002-responsive-behavior), [UI-SHELL-003](../../../docs/overview/004-ui-requirements.md#ui-shell-003-dark--light-color-scheme-toggle)
...
- [x] **Task FE-3.1: C2PA pre-upload client integration**
  ...
  - **Related Requirements:** [F-002](../../../docs/overview/002-prd.md#f-002-photo-upload), [F-012](../../../docs/overview/002-prd.md#f-012-c2pa-manifest-generation-on-upload), [SRS-F-002.1](../../../docs/overview/003-srs.md#srs-f-002-photo-upload)
...
- [ ] **Task FE-3.2: Photo upload and My Gallery grid**
  ...
  - **Related Requirements:** [F-002](../../../docs/overview/002-prd.md#f-002-photo-upload), [F-003](../../../docs/overview/002-prd.md#f-003-personal-gallery-grid-path-a--own-uploads), [SRS-F-002](../../../docs/overview/003-srs.md#srs-f-002-photo-upload), [SRS-F-003](../../../docs/overview/003-srs.md#srs-f-003-personal-gallery-grid-path-a), [UI-SCR-001](../../../docs/overview/004-ui-requirements.md#ui-scr-001-my-gallery-path-a)
...
- [ ] **Task FE-3.3: Album organization, captions, and album view**
  ...
  - **Related Requirements:** [F-004](../../../docs/overview/002-prd.md#f-004-album-organization), [F-005](../../../docs/overview/002-prd.md#f-005-captions-and-tags), [SRS-F-004](../../../docs/overview/003-srs.md#srs-f-004-album-organization), [SRS-F-005](../../../docs/overview/003-srs.md#srs-f-005-captions-and-tags), [UI-SCR-004](../../../docs/overview/004-ui-requirements.md#ui-scr-004-album-view)
...
- [ ] **Task FE-5.1: Permissioned album creation and space admin UI**
  ...
  - **Related Requirements:** [F-008](../../../docs/overview/002-prd.md#f-008-permissioned-gallery--album-access-happyview-permissioned-spaces-validation), [SRS-F-008](../../../docs/overview/003-srs.md#srs-f-008-permissioned-album-access-happyview-spaces), [NFR-002](../../../docs/overview/002-prd.md#nfr-002-public-by-default-transparency), [UI-SCR-006](../../../docs/overview/004-ui-requirements.md#ui-scr-006-permissioned-space-administration), [ADR-010](../../../docs/architecture/010-permissioned-spaces-storage.md)
...
- [ ] **Task FE-4.1: Discovery feed (Path B)**
  ...
  - **Related Requirements:** [F-010](../../../docs/overview/002-prd.md#f-010-network-discovery-feed-and-album-sourcing-path-b--happyview-index), [SRS-F-010](../../../docs/overview/003-srs.md#srs-f-010-network-discovery-feed-path-b), [UI-SCR-002](../../../docs/overview/004-ui-requirements.md#ui-scr-002-discovery-feed-path-b)
...
- [ ] **Task FE-4.2: Public profile and shareable links**
  ...
  - **Related Requirements:** [F-006](../../../docs/overview/002-prd.md#f-006-public-profile-gallery), [F-007](../../../docs/overview/002-prd.md#f-007-shareable-album-and-gallery-links), [SRS-F-006](../../../docs/overview/003-srs.md#srs-f-006-public-profile-gallery), [SRS-F-007](../../../docs/overview/003-srs.md#srs-f-007-shareable-album-and-gallery-links)
...
- [ ] **Task FE-4.3: Photo detail and deletion UX**
  ...
  - **Related Requirements:** [F-009](../../../docs/overview/002-prd.md#f-009-photo-deletion-and-album-membership-management), [SRS-F-009](../../../docs/overview/003-srs.md#srs-f-009-photo-deletion-and-album-membership), [UI-SCR-003](../../../docs/overview/004-ui-requirements.md#ui-scr-003-photo-detail)
...
- [ ] **Task FE-6.1: C2PA validation and trust configuration UI**
  ...
  - **Related Requirements:** [F-013](../../../docs/overview/002-prd.md#f-013-c2pa-provenance-on-edit-and-publish) through [F-016](../../../docs/overview/002-prd.md#f-016-c2pa-trust-configuration), [NFR-015](../../../docs/overview/002-prd.md#nfr-015-c2pa-privacy-and-selective-disclosure), [NFR-016](../../../docs/overview/002-prd.md#nfr-016-c2pa-neutral-trust-presentation), [UI-SCR-008](../../../docs/overview/004-ui-requirements.md#ui-scr-008-c2pa-trust-configuration)
...
- [ ] **Task FE-7.1: Frontend release-criteria UI verification**
  ...
  - **Related Requirements:** [RC-001](../../../docs/overview/002-prd.md#rc-001-end-to-end-upload-and-gallery) through [RC-009](../../../docs/overview/002-prd.md#rc-009-c2pa-upload-validation-and-edit-chain), [NFR-002](../../../docs/overview/002-prd.md#nfr-002-public-by-default-transparency)
  - **Related Tests:** All `apps/frontend/tests/features/ui_*.feature` and `*_SRS-*.feature`
  - **Agent Prompt:** `@AGENTS.md Begin by creating a new feature branch for Task FE-7.1. npm run build && npm run test:ui. Allure report. Walkthrough with full CLI output. Check off docs/overview/005-plan.md Task 7.1 frontend portion. Commit and push.`
