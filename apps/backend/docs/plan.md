...
Granular checklist for the FastAPI auxiliary service (C2PA, health, integration verification). Global sequencing: [docs/overview/005-plan.md](../../../docs/overview/005-plan.md).
...
- [ ] **Task BE-1.1: Backend scaffold, logging, and health verification**
  ...
  - **Dependencies:** None
  - **Related Requirements:** [NFR-004](../../../docs/overview/002-prd.md#nfr-004-observability-and-logging), [NFR-006](../../../docs/overview/002-prd.md#nfr-006-testability-and-quality-gates), [SRS-NFR-004](../../../docs/overview/003-srs.md#srs-nfr-004-observability-and-logging)
...
- [x] **Task BE-1.2: C2PA module scaffold expansion**
  ...
  - **Related Requirements:** [F-012](../../../docs/overview/002-prd.md#f-012-c2pa-manifest-generation-on-upload), [SRS-F-012](../../../docs/overview/003-srs.md#srs-f-012-c2pa-manifest-generation-on-upload)
...
- [ ] **Task BE-2.1: Lexicon publication integration tests**
  ...
  - **Related Requirements:** [F-011](../../../docs/overview/002-prd.md#f-011-lexicon-publication-and-network-indexing), [TC-005](../../../docs/overview/002-prd.md#tc-005-record-size-discipline), [SRS-F-011](../../../docs/overview/003-srs.md#srs-f-011-lexicon-publication-and-network-indexing)
...
- [ ] **Task BE-2.2: HappyView-only sync boundary test**
  ...
  - **Related Requirements:** [TC-012](../../../docs/overview/002-prd.md#tc-012-happyview-only-network-sync), [SRS-TC-012](../../../docs/overview/003-srs.md#technical-constraints)
...
- [ ] **Task BE-2.3: Authentication security integration tests**
  ...
  - **Estimated Time:** 2 hours
  - **Dependencies:** Task BE-2.1
  - **Related Requirements:** [NFR-003](../../../docs/overview/002-prd.md#nfr-003-authentication-security), [SRS-NFR-003](../../../docs/overview/003-srs.md#srs-nfr-003-authentication-security)
...
- [x] **Task BE-3.1: C2PA manifest generation on upload**
  ...
  - **Related Requirements:** [F-012](../../../docs/overview/002-prd.md#f-012-c2pa-manifest-generation-on-upload), [TC-009](../../../docs/overview/002-prd.md#tc-009-c2pa-manifest-embedding), [TC-010](../../../docs/overview/002-prd.md#tc-010-c2pa-actions-integrity), [NFR-014](../../../docs/overview/002-prd.md#nfr-014-c2pa-22-conformance), [SRS-F-012](../../../docs/overview/003-srs.md#srs-f-012-c2pa-manifest-generation-on-upload)
  - **Related Tests:** [`c2pa_manifest_generation_SRS-F-012.feature`](../tests/features/c2pa_manifest_generation_SRS-F-012.feature)
...
- [x] **Task BE-4.1: Permissioned spaces end-to-end integration**
  ...
  - **Related Requirements:** [F-008](../../../docs/overview/002-prd.md#f-008-permissioned-gallery--album-access-happyview-permissioned-spaces-validation), [TC-004](../../../docs/overview/002-prd.md#tc-004-repo-vs-space-storage-model), [TC-008](../../../docs/overview/002-prd.md#tc-008-permissioned-spaces-feature-flag), [NFR-013](../../../docs/overview/002-prd.md#nfr-013-permissioned-spaces-reference-validation), [SRS-F-008](../../../docs/overview/003-srs.md#srs-f-008-permissioned-album-access-happyview-spaces), [ADR-010](../../../docs/architecture/010-permissioned-spaces-storage.md)
...
- [ ] **Task BE-6.1: C2PA edit provenance and validation API**
  ...
  - **Related Requirements:** [F-013](../../../docs/overview/002-prd.md#f-013-c2pa-provenance-on-edit-and-publish) through [F-016](../../../docs/overview/002-prd.md#f-016-c2pa-trust-configuration), [SRS-F-013](../../../docs/overview/003-srs.md#srs-f-013-c2pa-provenance-on-edit-and-publish) through [SRS-F-016](../../../docs/overview/003-srs.md#srs-f-016-c2pa-trust-configuration)
...
- [ ] **Task BE-7.1: Data ownership and observability verification**
  ...
  - **Related Requirements:** [NFR-001](../../../docs/overview/002-prd.md#nfr-001-data-ownership-and-verifiability), [NFR-004](../../../docs/overview/002-prd.md#nfr-004-observability-and-logging), [RC-005](../../../docs/overview/002-prd.md#rc-005-observability-baseline), [SRS-NFR-001](../../../docs/overview/003-srs.md#srs-nfr-001-data-ownership-and-verifiability)
...
- [ ] **Task BE-7.2: Gallery query and C2PA validation performance tests**
  ...
  - **Related Requirements:** [NFR-011](../../../docs/overview/002-prd.md#nfr-011-gallery-query-performance), [NFR-017](../../../docs/overview/002-prd.md#nfr-017-c2pa-validation-performance)
  ...
  - **Agent Prompt:** `@AGENTS.md Begin by creating a new feature branch for Task BE-7.2. Run locust from apps/backend/tests/performance/. Document p95 in walkthrough. Check off global docs/overview/005-plan.md Task 7.2. Commit and push.`
...
- [ ] **Task BE-7.3: Zero-friction setup verification**
  ...
  - **Estimated Time:** 2 hours
  - **Dependencies:** Task BE-7.1
  - **Related Requirements:** [NFR-007](../../../docs/overview/002-prd.md#nfr-007-zero-friction-local-setup), [SRS-NFR-007](../../../docs/overview/003-srs.md#srs-nfr-007-zero-friction-local-setup)
